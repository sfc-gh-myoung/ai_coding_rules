**Description:** Comprehensive best practices for Snowflake Cortex Agents covering agent design, archetypes, configuration templates, tool design, planning instructions, RBAC, testing, and observability with prerequisites validation and error troubleshooting.
**AppliesTo:** `**/*.sql`, `**/*.py`
**AutoAttach:** false
