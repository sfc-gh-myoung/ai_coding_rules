**Description:** Best practices for Snowflake Cortex REST API usage: auth, endpoints, retries, streaming, idempotency, rate/cost controls, and when to use REST vs AISQL.
**AppliesTo:** `**/*.py`, `**/*.ts`, `**/*.sh`
**AutoAttach:** false
