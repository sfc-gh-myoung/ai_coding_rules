**Description:** Comprehensive best practices for Snowflake Dynamic Tables covering refresh modes, lag configuration, pipeline design, and performance optimization.
**AppliesTo:** `**/*.sql`
**AutoAttach:** false
...
- **Output Format:** Complete Dynamic Table DDL with all required parameters; monitoring queries
- **Validation Steps:**
