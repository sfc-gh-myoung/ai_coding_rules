...
Last updated: 2025-11-26 16:03:31
...
|| `440-react-core.md` | Applies to all React-based projects, including Next.js applications, Vite Single Page Apps (SPAs), and component libraries. Covers folder structure, state management, data fetching, styling, and testing. | React, Next.js, RSC, Hooks, Tailwind, Zustand, TanStack Query, Shadcn, Feature-based, TypeScript, Vitest, Testing Library | `rules/000-global-core.md`, `rules/420-javascript-core.md`, `rules/430-typescript-core.md` |
