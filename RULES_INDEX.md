...
Last updated: 2025-12-04 22:43:29
...
|| `200-python-core.md` | Foundational Python development practices with modern tooling (uv, Ruff) and project structure | Python, uv, Ruff, pyproject.toml, dependency management, virtual environments, modern Python tooling, pytest, validation, uv run, uvx, datetime.now(UTC), ty, type checking, type checker, mypy, type hints, static analysis | `rules/000-global-core.md` |
