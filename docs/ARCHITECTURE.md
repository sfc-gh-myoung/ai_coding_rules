...
| **400-499** | Frontend (JavaScript/TypeScript) | 420-javascript-core, 421-alpinejs (+421a), 424-javascript-docs, 430-typescript-core, 434-typescript-docs, 440-react-core, 441-react-backend |
...
- 188 rules covering all domains (including HTMX, Go/Golang, Alpine.js, Podman, and extensive companion rule families)
...
- `rules/` — 188 production-ready rule files
...
Validation:
  ✓ Source rules/ directory exists (188 files)
...
Deployment:
  ...
  → Copying 188 rule files...
  ✓ Copied 188 rules to /path/to/project/rules/
...
```mermaid
graph TD
    Root[ai_coding_rules/] --> Rules[rules/<br/>188 production files]
