...
- **Output Format:** Python DataFrames with standardized columns; SQL DDL with explicit PKs/FKs; View definitions with clear taxonomy prefixes
- **Validation Steps:** Run validation script; verify FK integrity; test business analyst queries; check view taxonomy compliance
