...
- **Scope:** Pandas DataFrame/Series operations, performance optimization, memory management, integration with Streamlit and Plotly
...
- **Output Format:** Performant Pandas code, minimal memory footprint, clear anti-pattern avoidance
- **Validation Steps:** Performance benchmarking (vectorized vs loop), memory profiling (dtype optimization), no SettingWithCopyWarning, efficient DataFrame operations
