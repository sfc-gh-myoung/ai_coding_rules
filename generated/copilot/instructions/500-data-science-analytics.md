...
- **Allowed Tools:** 
  - **SQL:** CTEs, window functions, APPROX_* functions, SAMPLE clause, QUALIFY
  - **Python:** Snowpark DataFrame API, scikit-learn, snowflake-ml, SHAP, matplotlib/plotly
  - **Visualization:** Streamlit (preferred), Plotly, Snowsight native charts
...
- **Snowflake Observability**: `111-snowflake-observability.md`
