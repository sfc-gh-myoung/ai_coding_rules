...
4. Load domain core rule (e.g., @420-javascript-core.md for frontend)
5. Load @002-rule-governance.md, @002a-rule-creation-guide.md, @002b-rule-optimization.md, @002d-schema-validator-usage.md
...
2. Load domain-specific rules:
   - Frontend (420-449): @420-javascript-core.md
   - Python (200-299): @200-python-core.md
   - Snowflake (100-199): @100-snowflake-core.md
   - Shell (300-399): @300-bash-scripting-core.md
   - Docker (400-499): @350-docker-best-practices.md
