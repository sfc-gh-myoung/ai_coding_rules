...
10. Regenerate RULES_INDEX.md with `uv run ai-rules index generate`
...
- [ ] RULES_INDEX.md regenerated (`uv run ai-rules index generate`)
...
6. Add CHANGELOG.md entry, then regenerate RULES_INDEX.md with `uv run ai-rules index generate`
