...
**When to Apply:** High-frequency data (e.g., 15-minute SCADA readings) creates noisy visualizations.

**Approach:** Time-based aggregation using pandas `resample()`.

**Complete Pattern:** See `101h-snowflake-streamlit-timeseries.md` for smoothing function, UI controls, and aggregation guidelines.
