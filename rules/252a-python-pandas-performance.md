...
schema_version: v3.5
rule_version: v2.0.0
description: "Pandas performance optimization: memory-efficient dtypes, categorical data, groupby/merge best practices, eval/query expressions, chunked processing, and thread-safety."
