...
Last updated: 2026-03-08 23:08:37
...
- **grant**, **rbac**, **security**: Consider `107-snowflake-security-governance.md`
...
- **notebook-approach**, **two-approach**: Consider `109f-snowflake-notebook-two-approach-pattern.md`
...
- **fastapi-security**, **oauth**: Consider `210a-python-fastapi-security.md`
...
**`003a-long-horizon-tasks.md`** - Strategies for managing context in long-horizon agent tasks: compaction protocols, structured note-taking for persistent memory, and sub-agent architectures for delegating and parallelizing work.
