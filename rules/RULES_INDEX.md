...
Last updated: 2026-03-08 14:36:35
...
- `.bash`, `.sh`: Load `300-bash-scripting-core.md`
- `.zsh`: Load `310b-zsh-compatibility.md`
...
- **ml-model**, **ml-observability**, **model-monitor**, **model-registry**: Consider `110-snowflake-model-registry.md`
...
- **pydantic**, **validation**: Consider `230-python-pydantic.md`
...
**`110-snowflake-model-registry.md`** - Comprehensive best practices for using Snowflake Model Registry to manage machine learning models, ensuring secure, performant, and governable ML operations through proper lifecycle management, access control, versioning strategies, MODEL MONITOR integration for ML Observability, and cost optimization.
...
**`501-frontend-browser-globals-collisions.md`** - No scope provided
