...
Examples:
  ...
  python token_validator.py --dry-run

  # Update with custom threshold
  python token_validator.py --threshold 20

  # Show detailed analysis
  python token_validator.py --detailed

  # Verbose output with all information
  python token_validator.py --verbose --detailed
        """,
    )
    ...
    if not args.dry_run and update_count > 0:
        ...
        print("2. Validate updates: python scripts/rule_validator.py")
