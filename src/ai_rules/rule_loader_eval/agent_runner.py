    ...
    *,
    ...
    options = CortexCodeAgentOptions(
        ...
        system_prompt=(
            ...
            "`grep -iwE 'KW1|KW2|KW3' rules/RULES_INDEX_COMPACT.md` to discover "
            "matching rules. RULES_INDEX_COMPACT.md has one space-separated row "
            "per rule; each matching row is self-contained — the rule filename "
            "is the first field, no further context lookup needed. COMPACT is "
            "the only agent discovery index — do not read the full human-only "
            "index.\n"
            ...
            "  - [x] Gate 2: RULES_INDEX_COMPACT.md searched for: keyword1, keyword2\n"
