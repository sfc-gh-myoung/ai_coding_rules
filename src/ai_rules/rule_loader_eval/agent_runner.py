    ...
    *,
    ...
    options = CortexCodeAgentOptions(
        ...
        system_prompt=(
            ...
            "`grep -iE -m 20 'KW1|KW2|KW3' rules/RULES_INDEX.md` to discover "
            "matching rules. RULES_INDEX.md has ~241 lines (one Markdown table "
            "row per rule); each matching row is self-contained — the rule "
            "filename is the first table column, no further context lookup "
            "needed.\n"
