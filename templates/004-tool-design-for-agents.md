**Description:** Token-efficient tool design patterns for AI agents, focusing on minimal overlap, clear contracts, and promoting efficient agent behaviors.
**Type:** Agent Requested
**AppliesTo:** Tool development files, agent frameworks
**AutoAttach:** false
...
- **Type:** Agent Requested
- **Scope:** Tool development for AI agents across all platforms (Claude, GPT, Gemini) and frameworks
...
- **Output Format:** Self-contained tools with clear specifications; token-efficient responses; structured error messages
- **Validation Steps:** Tool has single clear purpose; parameters are unambiguous; outputs are minimal and actionable; no overlap with other tools; agent can use tool effectively
