**Description:** Testing strategies, AppTest patterns, and debugging workflows for Streamlit applications
...
- **Type:** Agent Requested
- **Scope:** Streamlit testing with AppTest, unit testing data functions, debugging patterns
...
- **Output Format:** Test suite with unit tests for data functions, AppTest integration tests, >80% code coverage
- **Validation Steps:** All tests pass, edge cases covered, mocks used for external services, cache behavior tested
