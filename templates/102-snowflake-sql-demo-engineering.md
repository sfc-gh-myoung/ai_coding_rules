**Description:** SQL file patterns for Snowflake demos and customer learning environments
**Type:** Auto-attach
...
SELECT '✓ Schema created' AS progress;
...
SELECT '✓ GRID_ASSETS table created' AS progress;
...
SELECT '✓ FAILURE_EVENTS table created' AS progress;
...
SELECT '✓ Stage created' AS progress;
...
SELECT '✓ GRID_DATA schema removed' AS status;
```
...
SELECT '✓ Grid assets loaded' AS progress;
...
SELECT '✓ SCADA data loaded' AS progress;
