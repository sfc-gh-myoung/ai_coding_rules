**Description:** SQL templates and automation patterns for production Snowflake deployments
...
- **Git Workflow**: `806-git-workflow-management.md` - Branching and PR strategies
