...
### Related Rules
- **Semantic Views Core**: `106-snowflake-semantic-views.md` - DDL creation, validation rules, components
- **Semantic Views Querying**: `106a-snowflake-semantic-views-querying.md` - Query patterns and testing
...
- **Cortex Agents**: `114a-snowflake-cortex-agents.md` - Agent design and configuration
