**Description:** Integration patterns, governance, and development workflows for Snowflake Native Semantic Views with Cortex Analyst/Agent.
**Type:** Agent Requested
**AppliesTo:** `**/*.sql`, `**/*.py`
**AutoAttach:** false
**Keywords:** Cortex Analyst, Cortex Agent, REST API, RBAC, masking policy, row access policy, governance, Generator workflow, iterative development, synonyms, natural language queries, security, analyst integration, agent integration, semantic view security, NLQ setup, analyst API, agent tools
**TokenBudget:** ~4600
**ContextTier:** Medium
**Version:** 1.0
**LastUpdated:** 2025-11-15
**Depends:** 106-snowflake-semantic-views, 106a-snowflake-semantic-views-querying
...
- **Type:** Agent Requested
- **Scope:** Cortex integration, governance patterns, development workflows, Generator usage
