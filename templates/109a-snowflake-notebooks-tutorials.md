**Description:** Tutorial and learning design patterns for Snowflake notebooks, focusing on pedagogical structure, anti-patterns, checkpoints, and progressive learning approaches.
**Type:** Agent Requested
**AppliesTo:** `notebooks/**/*.ipynb`, tutorial content, educational materials
**AutoAttach:** false
