**Description:** Distributed tracing and metrics collection patterns for Snowflake including custom spans, performance analysis, trace attributes, and system metrics monitoring.
...
- **Type:** Agent Requested
- **Scope:** Distributed tracing with `snowflake-telemetry-python` package and metrics collection for Snowflake handlers
