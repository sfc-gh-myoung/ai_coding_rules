...
**AppliesTo:** `**/*.sql`, `**/*.py`
**AutoAttach:** false
**Keywords:** Cortex Analyst, semantic views, natural language queries, NL2SQL, agent tool configuration, semantic view design, Generator workflow, prerequisites validation, error troubleshooting, business metrics
**TokenBudget:** ~3800
**ContextTier:** Medium
**Version:** 1.5
...
**RECOMMENDED:**
**Follow iterative development workflow from `106-snowflake-semantic-views.md` Section 8:**
...
**Cross-Reference:**
- **Generator workflow**: See `106-snowflake-semantic-views.md` Section 8.1
- **Iterative development**: See `106-snowflake-semantic-views.md` Section 8.2
- **Testing patterns**: See `106-snowflake-semantic-views.md` Section 8.3
...
- **Semantic Views**: `106-snowflake-semantic-views.md` - Comprehensive semantic view DDL syntax, development best practices (Section 8), Generator workflow, testing patterns
