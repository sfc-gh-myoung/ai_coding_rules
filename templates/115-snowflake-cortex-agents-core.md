**Description:** Core best practices for Snowflake Cortex Agents covering prerequisites validation, agent archetypes, tooling strategy, and configuration templates.
