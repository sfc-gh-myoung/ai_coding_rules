**Description:** Planning and response instruction patterns for Snowflake Cortex Agents covering tool selection logic, orchestration patterns, and response formatting.
