**Description:** Operational best practices for Snowflake Cortex Agents covering testing, RBAC, observability, cost management, and error troubleshooting.
**Type:** Agent Requested
**AppliesTo:** `**/*.sql`, `**/*.py`
**AutoAttach:** false
**Keywords:** Cortex Agents, testing, RBAC, permissions, allowlists, observability, evaluation, cost management, error troubleshooting, agent security, test agent, agent permissions, agent RBAC setup, agent monitoring, agent evaluation, agent costs, debug agent, agent logs, agent trace, agent security policies
**TokenBudget:** ~3650
**ContextTier:** High
**Version:** 3.0
**LastUpdated:** 2025-11-20
**Depends:** 100-snowflake-core, 115-snowflake-cortex-agents-core, 111-snowflake-observability-core
...
- **Type:** Agent Requested
- **Scope:** Testing, RBAC, allowlists, observability, evaluation, cost optimization, error resolution

## Contract
- **Inputs/Prereqs:** Agent created and configured, tools defined, role strategy established
- **Allowed Tools:** Testing frameworks, RBAC commands, AI Observability, evaluation tools
- **Forbidden Tools:** Unbounded tool execution, privilege escalation
- **Required Steps:** 1) Component testing 2) Integration testing 3) RBAC enforcement 4) Add observability 5) Monitor costs
