**Description:** Operational patterns for Snowflake Data Quality Monitoring including scheduling, event tables, alerts, remediation, and RBAC configuration.
**Type:** Agent Requested
**AppliesTo:** `**/*.sql`, `**/*.py`
**AutoAttach:** false
**Keywords:** Data quality, DMF scheduling, event tables, alerts, remediation, RBAC, privilege requirements, automated monitoring, quality alerts, schedule DMF, quality event tables, quality alerting, DMF results, quality monitoring setup, quality workflows, DMF RBAC, quality notifications, remediation workflows
**TokenBudget:** ~4500
**ContextTier:** High
**Version:** 3.0
**LastUpdated:** 2025-11-20
**Depends:** 100-snowflake-core, 124-snowflake-data-quality-core, 111-snowflake-observability-core
...
## Rule Type and Scope
- **Type:** Agent Requested
- **Scope:** DMF scheduling, event tables, alerts, remediation, RBAC

## Contract
- **Inputs/Prereqs:** DMFs configured (from 124-core), expectations set (from 124a-custom)
- **Allowed Tools:** Tasks, event tables, alert configurations, RBAC commands
- **Forbidden Tools:** None specific
- **Required Steps:** 1) Schedule DMF evaluations 2) Configure event tables 3) Set up alerts 4) Define remediation 5) Configure RBAC
- **Output Format:** Task schedules, event table queries, alert configs, RBAC grants
- **Validation Steps:** Tasks run successfully; alerts trigger correctly; RBAC enforced
